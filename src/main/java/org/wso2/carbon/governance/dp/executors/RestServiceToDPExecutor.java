...
public class RestServiceToDPExecutor implements Execution{

    private static final Log LOG = LogFactory.getLog(RestServiceToDPExecutor.class);

    private String soapServiceMediaType = "application/vnd.wso2-rest-service+xml";
